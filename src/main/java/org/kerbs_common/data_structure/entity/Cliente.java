 ...
 * 
 * Uses TABLE_PER_CLASS inheritance strategy where each concrete subclass
 * has its own table with all inherited fields.
 * 
 * Design decisions:
 * - TABLE_PER_CLASS: Each subclass (Empresa, ClienteFinal) has its own table
